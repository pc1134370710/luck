...
public class GeneratoDemo {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/pcLuck?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//        表名，多个英文逗号分割
        strategy.setInclude("luck_raffle_record");
